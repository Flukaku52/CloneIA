...
class NoticiasCriptoScraper:
    ...
    def buscar_todas_noticias(self, max_por_portal: int = 5, max_total: int = 20) -> List[Dict[str, Any]]:
        """
        Busca notícias em todos os portais configurados.
        ...
        for portal in PORTAIS:
            ...
            noticias = self.buscar_noticias(portal, max_por_portal)
