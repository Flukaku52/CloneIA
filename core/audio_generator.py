...
class AudioGenerator:
    ...
    def __init__(self):
        ...
        # Configurações de voz com mais variação para tentar sotaque carioca
        self.voice_settings = {
            "stability": 0.55,  # Reduzido bastante para permitir mais variação
            "similarity_boost": 0.85,  # Aumentado para manter características da voz original
            "style": 0.25,  # Aumentado para mais expressividade
    ...
    def generate_audio(self, text: str, output_file: Optional[str] = None) -> Optional[str]:
        ...
        # Configurar payload com ajuste de velocidade
        payload = {
            "text": text,
            "model_id": "eleven_multilingual_v2",
            "voice_settings": self.voice_settings,
            "optimize_streaming_latency": 3  # Aumenta a fluidez e reduz pausas
        }
