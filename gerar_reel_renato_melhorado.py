#!/usr/bin/env python3
"""
Gera reel com o roteiro personalizado do Renato com abertura e fechamento melhorados
"""
...
def gerar_reel_melhorado():
    """Gera reel com abertura e fechamento melhorados"""
    
    # Roteiro com melhorias
    segmentos = [
        {
            "nome": "Abertura",
            "texto": "E aí cambada! Olha eu aí de novo. Bora pras novas!"
        },
        {
            "nome": "Connecticut vs Estados Pro-Cripto", 
            "texto": """O estado de Conecticut aprovou uma lei que impede o governo estadual e prefeituras de comprar, manter ou investir em criptomoedas. E também veta o uso de cripto como forma de pagamento em serviço público.
...
Enquanto governos tentam segurar ou proibir, o mercado segue validando uma moeda que não depende de bancos centrais."""
        ...
        {
            "nome": "Fechamento",
            "texto": """Por hoje é isso cambada. Governos tentando segurar a revolução. Brasileiros investindo além do tradicional. E o Bitcoin mostrando pra que veio.
...
Sigo de olho."""
    ...
    print("🎥 GERANDO REEL PERSONALIZADO MELHORADO")
    print("=" * 60)
    ...
    print("\n🔧 MELHORIAS APLICADAS:")
    print("   • Abertura natural com 'olha eu aí de novo'")
    print("   • Fechamento com pausas entre cada frase")
    print("   • Pausa maior antes do 'Sigo de olho'")
    
    # Inicializa o gerador de áudio
    audio_gen = AudioGenerator()
    
    # Diretório de saída
    output_dir = project_root / "output" / "reel_renato_melhorado" / "segments"
    output_dir.mkdir(parents=True, exist_ok=True)
    
    print("\n📊 FASE 1: Gerando áudios melhorados")
    print()
    ...
    print(f"   • Abertura: Mais rápida e fluida")
    print(f"   • Fechamento: Com pausas naturais")
    print(f"   • Tempo estimado: {total_duration/60:.1f} minutos")
    
    print("\n✅ Áudios melhorados prontos para HeyGen!")
    
    # Salva instruções
    instrucoes_path = project_root / "output" / "reel_renato_melhorado" / "INSTRUCOES_HEYGEN.txt"
    with open(instrucoes_path, 'w', encoding='utf-8') as f:
        f.write("INSTRUÇÕES PARA GERAR VÍDEO NO HEYGEN - VERSÃO MELHORADA\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("MELHORIAS APLICADAS:\n")
        f.write("• Abertura mais rápida: 'E aí cambada! Bora pras novas!'\n")
        f.write("• Fechamento melhorado com vírgulas e pausas\n")
        f.write("• 'Sigo de olho' separado no final\n\n")
